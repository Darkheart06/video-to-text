...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "agenda.untitled": {"ru": "Без названия", "en": "Untitled"},
    "agenda.today": {"ru": "Сегодня", "en": "Today"},
    "agenda.tomorrow": {"ru": "Завтра", "en": "Tomorrow"},
    "agenda.gone": {"ru": "Событие уже убрали", "en": "That event is gone"},
    "agenda.fromApp": {"ru": "Заведено из «Расшифровки записей»",
                       "en": "Added from the transcription app"},
    "agenda.soon": {"ru": "Через {minutes} мин: {title}",
                    "en": "In {minutes} min: {title}"},
    "agenda.now": {"ru": "Начинается: {title}", "en": "Starting now: {title}"},
    "agenda.withPeople": {"ru": "Участники: {people}", "en": "Attendees: {people}"},
    "agenda.clash": {"ru": "Накладывается на: {what}", "en": "Overlaps with: {what}"},
    "notify.title": {"ru": "Расшифровка записей", "en": "Transcription"},
    "notify.needSetup": {"ru": "Не заполнены токен и чат",
                         "en": "The token and the chat are not set"},
    "notify.needToken": {"ru": "Сначала впишите токен бота",
                         "en": "Enter the bot token first"},
    "notify.writeFirst": {"ru": "Напишите боту любое слово и нажмите ещё раз",
                          "en": "Send the bot any message, then press again"},
    "notify.test": {"ru": "Проверка связи: напоминания дойдут сюда.",
                    "en": "Test message: reminders will arrive here."},
    ...
    "rec.videoNotRecording": {"ru": "Запись экрана включается только во время записи",
                              "en": "Screen capture can only be switched during a recording"},
    "rec.videoRoom": {"ru": "На встрече в комнате пишется только микрофон",
                      "en": "A room meeting records the microphone only"},
    "rec.videoNoHelper": {"ru": "Помощник захвата не отвечает — запись экрана не переключить",
                          "en": "The capture helper is not answering — the screen cannot be switched"},
